    ...
    ***************************************************************************** */
    ...
    var NuLazyService = /** @class */ (function () {
        ...
        NuLazyService.prototype.fixPaths = function (paths) {
             ...
             */function (p) {
                /** @type {?} */
                var res = ( /** @type {?} */((typeof p === 'string' ? { path: p } : p)));
                if (!res.type) {
        ...
        NuLazyService.prototype.monitor = function (paths) {
            ...
            if (libs.length > 0) {
                 ...
                 * @param {?} ls
                 * @return {?}
                 */function (ls) { return ls.length === libs.length && ls.every(( /**
                 * @param {?} v
                 * @return {?}
                 */function (/**
                 * @param {?} v
                 * @return {?}
                 */ v) { return v.status === 'ok' && libs.find(( /**
                 * @param {?} lw
                 * @return {?}
                 */function (/**
                 * @param {?} lw
                 * @return {?}
                 */ lw) { return lw.path === v.path; })); })); })));
            }
        ...
        NuLazyService.prototype.load = function (paths) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, Promise.all((( /** @type {?} */(paths))).map(( /**
                         * @param {?} p
                         * @return {?}
                         */function (/**
                         * @param {?} p
                         * @return {?}
                         */ p) { return p.type === 'script' ? _this.loadScript(p.path, { callback: p.callback }) : _this.loadStyle(p.path); }))).then(( /**
                         * @param {?} res
                         * @return {?}
                         */function (/**
                         * @param {?} res
