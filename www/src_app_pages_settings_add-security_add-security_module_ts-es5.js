  ...
  (self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["src_app_pages_settings_add-security_add-security_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddSecurityPageRoutingModule": function AddSecurityPageRoutingModule() {
          return (
            /* binding */
            _AddSecurityPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _add_security_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-security.page */
      17174);
      ...
      var _AddSecurityPageRoutingModule = function AddSecurityPageRoutingModule() {
        _classCallCheck(this, AddSecurityPageRoutingModule);
      };

      _AddSecurityPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddSecurityPageModule": function AddSecurityPageModule() {
          return (
            /* binding */
            _AddSecurityPageModule
          );
        }
        /* harmony export */
      ...
      var _add_security_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-security-routing.module */
      69956);
      /* harmony import */


      var _add_security_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./add-security.page */
      17174);
      /* harmony import */
      ...
      var _AddSecurityPageModule = function AddSecurityPageModule() {
        _classCallCheck(this, AddSecurityPageModule);
      };

      _AddSecurityPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__.SharedModule, _add_security_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddSecurityPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddSecurityPage": function AddSecurityPage() {
          return (
            /* binding */
            _AddSecurityPage
          );
      ...
      var _raw_loader_add_security_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./add-security.page.html */
      3179);
      /* harmony import */


      var _add_security_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./add-security.page.scss */
      17738);
      /* harmony import */
      ...
      var _AddSecurityPage = /*#__PURE__*/function () {
        // Variables end
        function AddSecurityPage(toastController, menuCtrl, http, commonUtils, // common functionlity come here
        router, activatedRoute) {
          _classCallCheck(this, AddSecurityPage);
          ...
          this.hide = true;
          this.hide2 = true;
          this.imageSrc = ''; // Date format change end
          // ======================== form submit start ===================

          this.formLoading = false;
        }

        _createClass(AddSecurityPage, [{
          key: "ngOnInit",
          ...
          value: function commonFunction() {
            ...
            console.log('this.model.amdDob', this.model.amdDob); // edit api

            if (this.parms_action_name == 'edit') {
              this.editApi = 'institute/view/' + this.parms_action_id; // init call

              this.init();
              this.editForm_api = 'institute/update/' + this.parms_action_id;
            } else if (this.parms_action_name == 'add') {
              this.model.instMnumCode = '+91';
              this.model.amdMnumCode = '+91'; // form_api Api
          ...
          key: "passwordGenarate",
          value: function passwordGenarate(_userName) {
          ...
          value: function init() {
            ...
            if (this.parms_action_name == 'edit') {
              ...
              this.editDataSubscribe = this.http.get(this.editApi).subscribe(function (res) {
                ...
                _this.model.chkAmdDob = moment__WEBPACK_IMPORTED_MODULE_2__(res.instituteAdmin[0].amdDob).format('YYYY-MM-DD');
                _this.model.chkRegDate = moment__WEBPACK_IMPORTED_MODULE_2__(res.isntRegDate).format('YYYY-MM-DD');
                _this.model.chkEstDate = moment__WEBPACK_IMPORTED_MODULE_2__(res.instEndDate).format('YYYY-MM-DD');
                console.log('this.model.amdDob', _this.model.amdDob);
                console.log('this.model.isntRegDate', _this.model.isntRegDate);
                console.log('this.model.instEndDate', _this.model.instEndDate);
                _this.model.instMnumCode = res.instMnum.slice(0, 3);
                _this.model.instMnumPh = res.instMnum.slice(3);
                _this.model.amdMnumCode = res.instituteAdmin[0].amdMnum.slice(0, 3);
                _this.model.amdMnumPh = res.instituteAdmin[0].amdMnum.slice(3); // edit data

                _this.allEditData = res;
                console.log('this.allEditData', _this.allEditData);
              }, function (errRes) {
          ...
          key: "mobileNumberCode",
          value: function mobileNumberCode(_identifier, _purpose, _value) {
            if (_identifier == 'onrMobileNumber') {
              var code = this.model.amdMnumCode;
              var number = this.model.amdMnumPh;
              ...
              var _code = this.model.instMnumCode;
              var _number = this.model.instMnumPh;
              ...
              console.log('mobile No:', _code + _number);
              this.model.instMnum = _code + _number;
            }
            ...
            if (this.parms_action_name == 'edit') {
              ...
              this.formSubmitSubscribe = this.http.put(this.editForm_api, form.value).subscribe(function (response) {
                ...
                if (response.status == 200) {
                  _this2.commonUtils.presentToast('success', response.message);

                  _this2.router.navigateByUrl('/security-list');

                  form.reset();
                } else {
                  _this2.commonUtils.presentToast('error', response.message);
                }
              }, function (errRes) {
                _this2.formLoading = false;
              });
        ...
        return AddSecurityPage;
      }();

      _AddSecurityPage.ctorParameters = function () {
        return [{
      ...
      _AddSecurityPage = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
...
//# sourceMappingURL=src_app_pages_settings_add-security_add-security_module_ts-es5.js.map