(self["webpackChunkuLearnSuperAdmin"] = self["webpackChunkuLearnSuperAdmin"] || []).push([["node_modules_ionic_core_dist_esm_ion-app_8_entry_js"],{
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_swipe-back-ee838cf8_js").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-ee838cf8.js */ 22557))).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
